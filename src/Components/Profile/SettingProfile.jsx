                        ...
                        <div class="inner-cover">
                            ...
                            <div class="btn-group cover-menu-mobile hidden-lg hidden-md">
                                ...
                                <ul class="dropdown-menu pull-right no-border" role="menu">
                                    <li ><a href="/profile"><i class="fa fa-fw fa-clock-o"></i> <span>Timeline</span></a></li>
                                    <li class="active"><a href="/profile/setting"><i class="fa fa-fw fa-user"></i> <span>About</span></a></li>
